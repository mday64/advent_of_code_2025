...
pub fn part2_gauss(input: &str) -> i32 {
...
";
    ...
    #[test]
    fn test_example() {
        assert_eq!(part2_gauss(EXAMPLE_INPUT), 33);
    }

    #[test]
    fn test_line3() {
        let input = "[.###] (0,1) (0,3) (3) (0,2) (1,3) {14,19,7,36}\n";
        assert_eq!(part2_gauss(input), 43);
    }
    ...
    fn test_line22() {
        ...
        assert_eq!(part2_gauss(input), 68);
    }

    #[test]
    fn test_line26() {
        let input = "[###.] (0) (1,2) (1,3) (0,1,3) (0,2) (0,1) {52,43,35,10}\n";
        assert_eq!(part2_gauss(input), 65);
    }

    #[test]
    fn test_part2_gauss_full() {
        assert_eq!(part2_gauss(FULL_INPUT), 15631);
    }
}
